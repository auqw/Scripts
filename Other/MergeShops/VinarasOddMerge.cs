...
public class VinarasOddMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "40676",
            "Googly Head",
            "Mode: [select] only\nShould the bot buy \"Googly Head\" ?",
            false
        ),
        new Option<bool>(
            "40857",
            "Great Mace",
            "Mode: [select] only\nShould the bot buy \"Great Mace\" ?",
            false
        ),
        new Option<bool>(
            "42117",
            "Ode to Joy Scythe",
            "Mode: [select] only\nShould the bot buy \"Ode to Joy Scythe\" ?",
            false
        ),
        new Option<bool>(
            "41857",
            "Gold Rune Staff",
            "Mode: [select] only\nShould the bot buy \"Gold Rune Staff\" ?",
            false
        ),
        new Option<bool>(
            "41710",
            "Empty Cauldron Helm",
            "Mode: [select] only\nShould the bot buy \"Empty Cauldron Helm\" ?",
            false
        ),
        new Option<bool>(
            "33549",
            "Cursed Bard's Cape",
            "Mode: [select] only\nShould the bot buy \"Cursed Bard's Cape\" ?",
            false
        ),
        new Option<bool>(
            "35246",
            "Strange Cat Face",
            "Mode: [select] only\nShould the bot buy \"Strange Cat Face\" ?",
            false
        ),
        new Option<bool>(
            "29768",
            "Borked Blade of Dragon Control",
            "Mode: [select] only\nShould the bot buy \"Borked Blade of Dragon Control\" ?",
            false
        ),
        new Option<bool>(
            "29459",
            "Seraph Avenger",
            "Mode: [select] only\nShould the bot buy \"Seraph Avenger\" ?",
            false
        ),
        new Option<bool>(
            "29458",
            "Necrotic Avenger",
            "Mode: [select] only\nShould the bot buy \"Necrotic Avenger\" ?",
            false
        ),
        new Option<bool>(
            "46076",
            "Dark Infernal Companion",
            "Mode: [select] only\nShould the bot buy \"Dark Infernal Companion\" ?",
            false
        ),
        new Option<bool>(
            "48604",
            "GrandPapa the Golden Sneevil Morph",
            "Mode: [select] only\nShould the bot buy \"GrandPapa the Golden Sneevil Morph\" ?",
            false
        ),
        new Option<bool>(
            "48606",
            "Papa the Sneevil",
            "Mode: [select] only\nShould the bot buy \"Papa the Sneevil\" ?",
            false
        ),
    };
}
