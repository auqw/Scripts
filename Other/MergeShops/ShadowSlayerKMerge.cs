...
public class ShadowSlayerKMerge
{
                ...
                case "Shadowslayer Apprentice Badge":
                    ...
                    while (!Bot.ShouldExit && !Core.CheckInventory(req.Name, quant))
                    {
                        ...
                        if (!Core.CheckInventory("Elders' Blood"))
                            Core.Logger(
                                "You ran out Elders' Blood, run the bot again at a later date.",
                                messageBox: true,
                                stopBot: true
                            );
    ...
    [
        new Option<bool>(
            "62993",
            "Imperial Infantry",
            "Mode: [select] only\nShould the bot buy \"Imperial Infantry\" ?",
            false
        ),
        new Option<bool>(
            "62994",
            "Imperial Morion",
            "Mode: [select] only\nShould the bot buy \"Imperial Morion\" ?",
            false
        ),
        new Option<bool>(
            "62995",
            "Imperial Arsenal",
            "Mode: [select] only\nShould the bot buy \"Imperial Arsenal\" ?",
            false
        ),
        new Option<bool>(
            "62996",
            "Imperial Shield Cape",
            "Mode: [select] only\nShould the bot buy \"Imperial Shield Cape\" ?",
            false
        ),
        new Option<bool>(
            "62997",
            "Imperial Gladius",
            "Mode: [select] only\nShould the bot buy \"Imperial Gladius\" ?",
            false
        ),
        new Option<bool>(
            "62999",
            "Imperial Longcast Rifle",
            "Mode: [select] only\nShould the bot buy \"Imperial Longcast Rifle\" ?",
            false
        ),
        new Option<bool>(
            "62998",
            "Imperial Gladius + Pavise",
            "Mode: [select] only\nShould the bot buy \"Imperial Gladius + Pavise\" ?",
            false
        ),
        new Option<bool>(
            "59117",
            "Surtara Myrmidon",
            "Mode: [select] only\nShould the bot buy \"Surtara Myrmidon\" ?",
            false
        ),
        new Option<bool>(
            "59118",
            "Surtara Armet",
            "Mode: [select] only\nShould the bot buy \"Surtara Armet\" ?",
            false
        ),
        new Option<bool>(
            "59119",
            "Surtara Kabuto",
            "Mode: [select] only\nShould the bot buy \"Surtara Kabuto\" ?",
            false
        ),
        new Option<bool>(
            "59120",
            "Surtara Mantle",
            "Mode: [select] only\nShould the bot buy \"Surtara Mantle\" ?",
            false
        ),
        new Option<bool>(
            "59121",
            "Surtara Rings",
            "Mode: [select] only\nShould the bot buy \"Surtara Rings\" ?",
            false
        ),
        new Option<bool>(
            "59122",
            "Surtara Wings",
            "Mode: [select] only\nShould the bot buy \"Surtara Wings\" ?",
            false
        ),
        new Option<bool>(
            "59123",
            "Surtara Gladius",
            "Mode: [select] only\nShould the bot buy \"Surtara Gladius\" ?",
            false
        ),
        new Option<bool>(
            "59124",
            "Surtara Maul",
            "Mode: [select] only\nShould the bot buy \"Surtara Maul\" ?",
            false
        ),
        new Option<bool>(
            "59125",
            "Surtara Nagamaki",
            "Mode: [select] only\nShould the bot buy \"Surtara Nagamaki\" ?",
            false
        ),
        new Option<bool>(
            "63034",
            "ShadowSlayer's Apprentice",
            "Mode: [select] only\nShould the bot buy \"ShadowSlayer's Apprentice\" ?",
            false
        ),
        new Option<bool>(
            "59115",
            "Chibi ShadowSlayer K",
            "Mode: [select] only\nShould the bot buy \"Chibi ShadowSlayer K\" ?",
            false
        ),
        new Option<bool>(
            "56038",
            "Antiquated Shadowslayer",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadowslayer\" ?",
            false
        ),
        new Option<bool>(
            "56039",
            "Antiquated Shadow Hair",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Hair\" ?",
            false
        ),
        new Option<bool>(
            "56040",
            "Antiquated Shadow Hat",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Hat\" ?",
            false
        ),
        new Option<bool>(
            "56041",
            "Antiquated Shadow Locks",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Locks\" ?",
            false
        ),
        new Option<bool>(
            "56042",
            "Antiquated Shadow Hat + Locks",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Hat + Locks\" ?",
            false
        ),
        new Option<bool>(
            "56043",
            "Antiquated Shadow Cloak",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Cloak\" ?",
            false
        ),
        new Option<bool>(
            "56044",
            "Antiquated Shadow Sabre",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Sabre\" ?",
            false
        ),
        new Option<bool>(
            "56045",
            "Antiquated Shadow Swordstaff",
            "Mode: [select] only\nShould the bot buy \"Antiquated Shadow Swordstaff\" ?",
            false
        ),
        new Option<bool>(
            "56046",
