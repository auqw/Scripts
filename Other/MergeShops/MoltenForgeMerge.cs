...
public class MoltenForgeMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "40605",
            "Lavamorphosis",
            "Mode: [select] only\nShould the bot buy \"Lavamorphosis\" ?",
            false
        ),
        new Option<bool>(
            "40607",
            "Lavamorph Helm",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Helm\" ?",
            false
        ),
        new Option<bool>(
            "40608",
            "Lavamorph Eyes",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Eyes\" ?",
            false
        ),
        new Option<bool>(
            "40606",
            "Lavamorph Visor",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Visor\" ?",
            false
        ),
        new Option<bool>(
            "40612",
            "Lavamorph Wings",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Wings\" ?",
            false
        ),
        new Option<bool>(
            "40609",
            "Lavamorph Stinger",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Stinger\" ?",
            false
        ),
        new Option<bool>(
            "40611",
            "Lavamorph Venom",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Venom\" ?",
            false
        ),
        new Option<bool>(
            "40610",
            "Lavamorph Dual Banes",
            "Mode: [select] only\nShould the bot buy \"Lavamorph Dual Banes\" ?",
            false
        ),
    };
}
