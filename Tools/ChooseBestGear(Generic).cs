...
public class ChooseGenericBestGear
{
    ...
    {
        new Option<GenericGearBoost>(
            "GenericGearBoost",
            "Generic Gear Boost",
            "Choose From dropmenu list what Generic Gear Boost you want to equip ",
            GenericGearBoost.dmgAll
        ),
        new Option<bool>(
            "EnhanceEquipment",
            "Enhance Equipment",
            "Specifiy if your generic equipment to be enhanced or not",
            true
        ),
    ...
    public void ScriptMain(IScriptInterface bot)
    {
        ...
        ChooseItem(
            Bot.Config!.Get<GenericGearBoost>("GenericGearBoost"),
    ...
    public void ChooseItem(
        GenericGearBoost gearBoost = GenericGearBoost.dmgAll,
