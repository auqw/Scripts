...
public class CheckArmyRoles
{
    ...
    private string[] HeroMartClasses =
    {
        ...
        "ChronoCorruptor",
        "ChronoCommander",
        // Extra Chrono variants from second list
        "Phantom Chronomancer",
        "Phantasm Chronomancer",
        "Draconic Chronomancer",
        // Non-Chrono HM Classes
        "CardClasher",
        "Classic Guardian",
        "Guardian",
        "Classic Dragonlord",
        ...
        "Nu Metal Necro",
        "Unchained Rocker",
        // Time-Adjacent Classes
        "ShadowStalker of Time",
        "ShadowWalker of Time",
        "ShadowWeaver of Time",
        "TimeKeeper",
        "TimeKiller",
        // Space / Interstellar / Knight Types
        "Interstellar Knight",
        "Infinity Knight",
        "Star Captain",
        "StarLord",
