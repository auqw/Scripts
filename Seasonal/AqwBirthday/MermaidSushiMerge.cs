...
public class MermaidSushiMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "72957",
            "Coffeemancer",
            "Mode: [select] only\nShould the bot buy \"Coffeemancer\" ?",
            false
        ),
        new Option<bool>(
            "72958",
            "Barista Beard",
            "Mode: [select] only\nShould the bot buy \"Barista Beard\" ?",
            false
        ),
        new Option<bool>(
            "72960",
            "Barista Bun and Glasses",
            "Mode: [select] only\nShould the bot buy \"Barista Bun and Glasses\" ?",
            false
        ),
        new Option<bool>(
            "72963",
            "Coffee Guzzler",
            "Mode: [select] only\nShould the bot buy \"Coffee Guzzler\" ?",
            false
        ),
        new Option<bool>(
            "72964",
            "Zorbak the Coffee Fiend",
            "Mode: [select] only\nShould the bot buy \"Zorbak the Coffee Fiend\" ?",
            false
        ),
        new Option<bool>(
            "72965",
            "Scarbucks Carpet",
            "Mode: [select] only\nShould the bot buy \"Scarbucks Carpet\" ?",
            false
        ),
        new Option<bool>(
            "72968",
            "Scarbucks Barista Gear",
            "Mode: [select] only\nShould the bot buy \"Scarbucks Barista Gear\" ?",
            false
        ),
        new Option<bool>(
            "72969",
            "Scarbucks Tray",
            "Mode: [select] only\nShould the bot buy \"Scarbucks Tray\" ?",
            false
        ),
    };
}
