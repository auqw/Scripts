...
public class GrenstoryMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "34374",
            "Shamanic Summoner",
            "Mode: [select] only\nShould the bot buy \"Shamanic Summoner\" ?",
            false
        ),
        new Option<bool>(
            "34376",
            "Raptor",
            "Mode: [select] only\nShould the bot buy \"Raptor\" ?",
            false
        ),
        new Option<bool>(
            "34373",
            "Azure Egg Staff",
            "Mode: [select] only\nShould the bot buy \"Azure Egg Staff\" ?",
            false
        ),
        new Option<bool>(
            "34370",
            "Shamanic Summoner Helm",
            "Mode: [select] only\nShould the bot buy \"Shamanic Summoner Helm\" ?",
            false
        ),
        new Option<bool>(
            "34371",
            "Tribal Feathers",
            "Mode: [select] only\nShould the bot buy \"Tribal Feathers\" ?",
            false
        ),
        new Option<bool>(
            "34369",
            "Jurassic Grenwog",
            "Mode: [select] only\nShould the bot buy \"Jurassic Grenwog\" ?",
            false
        ),
        new Option<bool>(
            "34372",
            "Jurassic Grenwog Tail",
            "Mode: [select] only\nShould the bot buy \"Jurassic Grenwog Tail\" ?",
            false
        ),
        new Option<bool>(
            "34378",
            "Raptor Morph",
            "Mode: [select] only\nShould the bot buy \"Raptor Morph\" ?",
            false
        ),
        new Option<bool>(
            "34377",
            "Raptor Tail",
            "Mode: [select] only\nShould the bot buy \"Raptor Tail\" ?",
            false
        ),
    };
}
