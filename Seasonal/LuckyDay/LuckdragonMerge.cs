...
public class LuckdragonMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "38875",
            "Lucky Looter",
            "Mode: [select] only\nShould the bot buy \"Lucky Looter\" ?",
            false
        ),
        new Option<bool>(
            "38876",
            "Sneaky Lucky Looter Hair",
            "Mode: [select] only\nShould the bot buy \"Sneaky Lucky Looter Hair\" ?",
            false
        ),
        new Option<bool>(
            "38877",
            "Sneaky Lucky Looter Locks",
            "Mode: [select] only\nShould the bot buy \"Sneaky Lucky Looter Locks\" ?",
            false
        ),
        new Option<bool>(
            "38878",
            "Lucky Boy Hair",
            "Mode: [select] only\nShould the bot buy \"Lucky Boy Hair\" ?",
            false
        ),
        new Option<bool>(
            "38879",
            "Lucky Girl Locks",
            "Mode: [select] only\nShould the bot buy \"Lucky Girl Locks\" ?",
            false
        ),
        new Option<bool>(
            "38880",
            "Gold Sack",
            "Mode: [select] only\nShould the bot buy \"Gold Sack\" ?",
            false
        ),
        new Option<bool>(
            "38881",
            "Gold Sack on your Back",
            "Mode: [select] only\nShould the bot buy \"Gold Sack on your Back\" ?",
            false
        ),
    };
}
