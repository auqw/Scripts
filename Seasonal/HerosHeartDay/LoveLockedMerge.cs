...
public class LoveLockedMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "38455",
            "TwillyBall",
            "Mode: [select] only\nShould the bot buy \"TwillyBall\" ?",
            false
        ),
        new Option<bool>(
            "38457",
            "Book Swarm Pet",
            "Mode: [select] only\nShould the bot buy \"Book Swarm Pet\" ?",
            false
        ),
        new Option<bool>(
            "38453",
            "Love Harvester",
            "Mode: [select] only\nShould the bot buy \"Love Harvester\" ?",
            false
        ),
        new Option<bool>(
            "38459",
            "Pa-Love-Din",
            "Mode: [select] only\nShould the bot buy \"Pa-Love-Din\" ?",
            false
        ),
        new Option<bool>(
            "38460",
            "Pa-Love-Din Helm",
            "Mode: [select] only\nShould the bot buy \"Pa-Love-Din Helm\" ?",
            false
        ),
        new Option<bool>(
            "38468",
            "Gilded Hourglass of Love",
            "Mode: [select] only\nShould the bot buy \"Gilded Hourglass of Love\" ?",
            false
        ),
        new Option<bool>(
            "38456",
            "TwigBall",
            "Mode: [select] only\nShould the bot buy \"TwigBall\" ?",
            false
        ),
    };
}
