...
public class UndeadSnugglegramsMerge
{
    ...
    public List<IOption> Select = new()
    {
        ...
        new Option<bool>("99110", "Royal Swordhaven Pendragon", "Mode: [select] only\nShould the bot buy \"Royal Swordhaven Pendragon\" ?", false),
        new Option<bool>("99111", "Valiant Swordhaven Pendragon", "Mode: [select] only\nShould the bot buy \"Valiant Swordhaven Pendragon\" ?", false),
        new Option<bool>("99115", "Swordhaven Pendragon Guard", "Mode: [select] only\nShould the bot buy \"Swordhaven Pendragon Guard\" ?", false),
        new Option<bool>("99116", "Swordhaven Pendragon Plume", "Mode: [select] only\nShould the bot buy \"Swordhaven Pendragon Plume\" ?", false),
        new Option<bool>("99124", "Silver Ehangwen", "Mode: [select] only\nShould the bot buy \"Silver Ehangwen\" ?", false),
        new Option<bool>("99127", "Royal Shadowscythe Visionary", "Mode: [select] only\nShould the bot buy \"Royal Shadowscythe Visionary\" ?", false),
        new Option<bool>("99128", "Forsaken Shadowscythe Visionary", "Mode: [select] only\nShould the bot buy \"Forsaken Shadowscythe Visionary\" ?", false),
        new Option<bool>("99130", "Shadowscythe Visionary Guard", "Mode: [select] only\nShould the bot buy \"Shadowscythe Visionary Guard\" ?", false),
        new Option<bool>("99139", "Crimson Halberd", "Mode: [select] only\nShould the bot buy \"Crimson Halberd\" ?", false),
        new Option<bool>("99330", "Doomknight Tyrant Horns", "Mode: [select] only\nShould the bot buy \"Doomknight Tyrant Horns\" ?", false),
        new Option<bool>("99331", "Doomknight Tyrant Barbute", "Mode: [select] only\nShould the bot buy \"Doomknight Tyrant Barbute\" ?", false),
        new Option<bool>("99335", "Doomknight Tyrant's Gaze", "Mode: [select] only\nShould the bot buy \"Doomknight Tyrant's Gaze\" ?", false),
        new Option<bool>("99341", "Tyrannical Devastation", "Mode: [select] only\nShould the bot buy \"Tyrannical Devastation\" ?", false),
        new Option<bool>("99342", "Tyrannical Destruction", "Mode: [select] only\nShould the bot buy \"Tyrannical Destruction\" ?", false),
   };
}
