...
public class PirateHuntMerge
{
    ...
    private static PirateHuntStory PirateHuntStory
    {
        get => _PirateHuntStory ??= new PirateHuntStory();
        set => _PirateHuntStory = value;
    }
        ...
        void findIngredients()
        {
            ...
            switch (req.Name)
            {
                ...
                case "Dual Cutlass of Awe":
                    ...
                    {
                        if (
                            !Core.isCompletedBefore(10388) && !Core.CheckInventory("Cutlass of Awe")
                        )
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "94712",
            "Novac Sal Pirate",
            "Mode: [select] only\nShould the bot buy \"Novac Sal Pirate\" ?",
            false
        ),
        new Option<bool>(
            "94713",
            "Novac Sal Privateer",
            "Mode: [select] only\nShould the bot buy \"Novac Sal Privateer\" ?",
            false
        ),
        new Option<bool>(
            "94714",
            "Novac Sal Pirate Morph",
            "Mode: [select] only\nShould the bot buy \"Novac Sal Pirate Morph\" ?",
            false
        ),
        new Option<bool>(
            "94715",
            "Novac Sal Pirate Visage",
            "Mode: [select] only\nShould the bot buy \"Novac Sal Pirate Visage\" ?",
            false
        ),
        new Option<bool>(
            "94723",
            "First Gold Cutlass",
            "Mode: [select] only\nShould the bot buy \"First Gold Cutlass\" ?",
            false
        ),
        new Option<bool>(
            "94724",
            "First Gold Cutlasses",
            "Mode: [select] only\nShould the bot buy \"First Gold Cutlasses\" ?",
            false
        ),
        new Option<bool>(
            "94716",
            "Novac Sal Crew Morph",
            "Mode: [select] only\nShould the bot buy \"Novac Sal Crew Morph\" ?",
            false
        ),
        new Option<bool>(
            "94717",
            "Novac Sal Crew Visage",
            "Mode: [select] only\nShould the bot buy \"Novac Sal Crew Visage\" ?",
            false
        ),
        new Option<bool>(
            "94727",
            "Pirate's First Gold",
            "Mode: [select] only\nShould the bot buy \"Pirate's First Gold\" ?",
            false
        ),
        new Option<bool>(
            "95375",
            "First Mate o' Awe",
            "Mode: [select] only\nShould the bot buy \"First Mate o' Awe\" ?",
            false
        ),
        new Option<bool>(
            "95376",
            "Captain o' Awe Cap",
            "Mode: [select] only\nShould the bot buy \"Captain o' Awe Cap\" ?",
            false
        ),
        new Option<bool>(
            "95377",
            "Captain o' Awe Locks",
            "Mode: [select] only\nShould the bot buy \"Captain o' Awe Locks\" ?",
            false
        ),
        new Option<bool>(
            "95378",
            "Captain o' Awe Patch",
            "Mode: [select] only\nShould the bot buy \"Captain o' Awe Patch\" ?",
            false
        ),
        new Option<bool>(
            "95379",
            "Captain o' Awe Eyepatch",
            "Mode: [select] only\nShould the bot buy \"Captain o' Awe Eyepatch\" ?",
            false
        ),
        new Option<bool>(
            "95382",
            "Sheathed Rapier of Awe",
            "Mode: [select] only\nShould the bot buy \"Sheathed Rapier of Awe\" ?",
            false
        ),
        new Option<bool>(
            "95386",
            "Dual Cutlass of Awe",
            "Mode: [select] only\nShould the bot buy \"Dual Cutlass of Awe\" ?",
            false
        ),
        new Option<bool>(
            "95387",
            "Rapier of Awe",
            "Mode: [select] only\nShould the bot buy \"Rapier of Awe\" ?",
            false
        ),
        new Option<bool>(
            "95388",
            "Rapiers of Awe",
            "Mode: [select] only\nShould the bot buy \"Rapiers of Awe\" ?",
            false
        ),
    };
}
