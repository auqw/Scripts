...
public class YesMaamsMerge
{
    ...
    public List<IOption> Select = new()
    {
        new Option<bool>(
            "85061",
            "EbilNet Specialist Operator",
            "Mode: [select] only\nShould the bot buy \"EbilNet Specialist Operator\" ?",
            false
        ),
        new Option<bool>(
            "85060",
            "EbilNet Operator",
            "Mode: [select] only\nShould the bot buy \"EbilNet Operator\" ?",
            false
        ),
        new Option<bool>(
            "85050",
            "Ebil Company Scavenger",
            "Mode: [select] only\nShould the bot buy \"Ebil Company Scavenger\" ?",
            false
        ),
        new Option<bool>(
            "85049",
            "Ebil Company",
            "Mode: [select] only\nShould the bot buy \"Ebil Company\" ?",
            false
        ),
        new Option<bool>(
            "85062",
            "EbilNet Helm",
            "Mode: [select] only\nShould the bot buy \"EbilNet Helm\" ?",
            false
        ),
        new Option<bool>(
            "85052",
            "Ebil Company Helmet",
            "Mode: [select] only\nShould the bot buy \"Ebil Company Helmet\" ?",
            false
        ),
        new Option<bool>(
            "84987",
            "Broken Binary Monitor",
            "Mode: [select] only\nShould the bot buy \"Broken Binary Monitor\" ?",
            false
        ),
        new Option<bool>(
            "85067",
            "EbilNet Flashlights",
            "Mode: [select] only\nShould the bot buy \"EbilNet Flashlights\" ?",
            false
        ),
        new Option<bool>(
            "85066",
            "EbilNet Flashlight",
            "Mode: [select] only\nShould the bot buy \"EbilNet Flashlight\" ?",
            false
        ),
        new Option<bool>(
            "85065",
            "EbilNet Signs",
            "Mode: [select] only\nShould the bot buy \"EbilNet Signs\" ?",
            false
        ),
        new Option<bool>(
            "85064",
            "EbilNet Sign",
            "Mode: [select] only\nShould the bot buy \"EbilNet Sign\" ?",
            false
        ),
        new Option<bool>(
            "84994",
            "NegaNet Protective Gear",
            "Mode: [select] only\nShould the bot buy \"NegaNet Protective Gear\" ?",
            false
        ),
        new Option<bool>(
            "85063",
            "EbilNet Code Tank",
            "Mode: [select] only\nShould the bot buy \"EbilNet Code Tank\" ?",
            false
        ),
        new Option<bool>(
            "85053",
            "Ebil Company Tanks",
            "Mode: [select] only\nShould the bot buy \"Ebil Company Tanks\" ?",
            false
        ),
        new Option<bool>(
            "84990",
            "Netspace Portal",
            "Mode: [select] only\nShould the bot buy \"Netspace Portal\" ?",
            false
        ),
        new Option<bool>(
            "85021",
            "Red ShadeScadoo Banner",
            "Mode: [select] only\nShould the bot buy \"Red ShadeScadoo Banner\" ?",
            false
        ),
        new Option<bool>(
            "85020",
            "Gray ShadeScadoo Banner",
            "Mode: [select] only\nShould the bot buy \"Gray ShadeScadoo Banner\" ?",
            false
        ),
        new Option<bool>(
            "85013",
            "Tear in Reality",
            "Mode: [select] only\nShould the bot buy \"Tear in Reality\" ?",
            false
        ),
        new Option<bool>(
            "85012",
            "Chairman's Signature",
            "Mode: [select] only\nShould the bot buy \"Chairman's Signature\" ?",
            false
        ),
    };
}
