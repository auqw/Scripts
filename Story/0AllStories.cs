...
public class AllStories
{
    ...
    // Legion
    private static CoreDageTheEvilIsland DageIsland
    {
        get => _DageIsland ??= new CoreDageTheEvilIsland();
        set => _DageIsland = value;
    }
    private static CoreDageTheEvilIsland _DageIsland;
    ...
    private static AtlasPromenade AtlasPromenade
    {
        get => _AtlasPromenade ??= new AtlasPromenade();
        set => _AtlasPromenade = value;
    }
    private static AtlasPromenade _AtlasPromenade;
    ...
    private static DarkWarLegionandNation DarkWar
    {
        get => _DarkWar ??= new DarkWarLegionandNation();
        set => _DarkWar = value;
    }
    private static DarkWarLegionandNation _DarkWar;
    private static Ravenscar Ravenscar
    {
        get => _Ravenscar ??= new Ravenscar();
        set => _Ravenscar = value;
    }
    private static Ravenscar _Ravenscar;
    private static SeraphicWar_Story SeraphicWar_Story
    {
        get => _SeraphicWar_Story ??= new SeraphicWar_Story();
        set => _SeraphicWar_Story = value;
    }
    private static SeraphicWar_Story _SeraphicWar_Story;
    private static SevenCircles SevenCircles
    {
        get => _SevenCircles ??= new SevenCircles();
        set => _SevenCircles = value;
    }
    private static SevenCircles _SevenCircles;
    private static WorldSoul WorldSoul
    {
        get => _WorldSoul ??= new WorldSoul();
        set => _WorldSoul = value;
    }
    private static WorldSoul _WorldSoul;
    ...
    private static DeadlyDungeon DeadlyDungeon
    {
        get => _DeadlyDungeon ??= new DeadlyDungeon();
        set => _DeadlyDungeon = value;
    }
    private static DeadlyDungeon _DeadlyDungeon;
    private static KillerCatacombs KillerCatacombs
    {
        get => _KillerCatacombs ??= new KillerCatacombs();
        set => _KillerCatacombs = value;
    }
    private static KillerCatacombs _KillerCatacombs;
    private static PyramidofPain PyramidofPain
    {
        get => _PyramidofPain ??= new PyramidofPain();
        set => _PyramidofPain = value;
    }
    private static PyramidofPain _PyramidofPain;

    // Lynaria
    private static CoreLynaria Lynaria
    {
    ...
    // Nation
    private static Bamboozle Bamboozle
    {
        get => _Bamboozle ??= new Bamboozle();
        set => _Bamboozle = value;
    }
    private static Bamboozle _Bamboozle;
    ...
    private static DeleuzeTundraStory DeleuzeTundra
    {
        get => _DeleuzeTundra ??= new DeleuzeTundraStory();
        set => _DeleuzeTundra = value;
    }
    private static DeleuzeTundraStory _DeleuzeTundra;
    private static FiendPast FiendPast
    {
        get => _FiendPast ??= new FiendPast();
        set => _FiendPast = value;
    }
    private static FiendPast _FiendPast;
    private static Fiendshard_Story Fiendshard_Story
    {
    ...
    private static Originul_Story Originul_Story
    {
        get => _Originul_Story ??= new Originul_Story();
        set => _Originul_Story = value;
    }
    private static Originul_Story _Originul_Story;
    private static ShadowBlastArena ShadowBlastArena
    {
    ...
    private static Tercessuinotlim _Tercessuinotlim;
    private static VoidRefuge VoidRefuge
    {
        get => _VoidRefuge ??= new VoidRefuge();
        set => _VoidRefuge = value;
    }
    private static VoidRefuge _VoidRefuge;
    ...
    private static QueenBattle QueenBattle
    {
        get => _QueenBattle ??= new QueenBattle();
        set => _QueenBattle = value;
    }
    private static QueenBattle _QueenBattle;
    ...
    private static CoreSummer CoreSummer
    {
        get => _CoreSummer ??= new CoreSummer();
        set => _CoreSummer = value;
    }
    private static CoreSummer _CoreSummer;
    ...
    //MemetsRealm
    private static MemetsRealm MemetsRealm
    {
        get => _MemetsRealm ??= new MemetsRealm();
        set => _MemetsRealm = value;
    }
    private static MemetsRealm _MemetsRealm;
    ...
    private static AranxQuests AranxQuests
    {
        get => _AranxQuests ??= new AranxQuests();
        set => _AranxQuests = value;
    }
    private static AranxQuests _AranxQuests;
    private static Arcangrove Arcangrove
    {
        get => _Arcangrove ??= new Arcangrove();
        set => _Arcangrove = value;
    }
    private static Arcangrove _Arcangrove;
    private static AriaGreenhouse AriaGreenhouse
    {
        get => _AriaGreenhouse ??= new AriaGreenhouse();
        set => _AriaGreenhouse = value;
    }
    private static AriaGreenhouse _AriaGreenhouse;
    private static AriaPet AriaPet
    {
        get => _AriaPet ??= new AriaPet();
        set => _AriaPet = value;
    }
    private static AriaPet _AriaPet;
    private static Artixpointe Artixpointe
    {
        get => _Artixpointe ??= new Artixpointe();
        set => _Artixpointe = value;
    }
    private static Artixpointe _Artixpointe;
    ...
    private static BaseCamp _BaseCamp;
    ...
    private static BeleensDream BeleensDream
    {
        get => _BeleensDream ??= new BeleensDream();
        set => _BeleensDream = value;
    }
    private static BeleensDream _BeleensDream;
    ...
    private static Bludrut Bludrut
    {
        get => _Bludrut ??= new Bludrut();
        set => _Bludrut = value;
    }
    private static Bludrut _Bludrut;
    ...
    private static CastleOfGlass CastleOfGlass
    {
        get => _CastleOfGlass ??= new CastleOfGlass();
        set => _CastleOfGlass = value;
    }
    private static CastleOfGlass _CastleOfGlass;
    private static CastleTunnels CastleTunnels
    {
        get => _CastleTunnels ??= new CastleTunnels();
        set => _CastleTunnels = value;
    }
    private static CastleTunnels _CastleTunnels;
    private static Cleric Cleric
    {
        get => _Cleric ??= new Cleric();
        set => _Cleric = value;
    }
    private static Cleric _Cleric;
    private static Concert Concert
    {
        get => _Concert ??= new Concert();
        set => _Concert = value;
    }
    private static Concert _Concert;
    private static Cornelis Cornelis
    {
        get => _Cornelis ??= new Cornelis();
        set => _Cornelis = value;
    }
    private static Cornelis _Cornelis;
    private static CrashSite CrashSite
    {
        get => _CrashSite ??= new CrashSite();
        set => _CrashSite = value;
    }
    private static CrashSite _CrashSite;
    ...
    private static DarkDungeon DarkDungeon
    {
        get => _DarkDungeon ??= new DarkDungeon();
        set => _DarkDungeon = value;
    }
    private static DarkDungeon _DarkDungeon;
    private static DeathsRealm DeathsRealm
    {
        get => _DeathsRealm ??= new DeathsRealm();
        set => _DeathsRealm = value;
    }
    private static DeathsRealm _DeathsRealm;
    ...
    private static DjinnGuard DjinnGuard
    {
        get => _DjinnGuard ??= new DjinnGuard();
        set => _DjinnGuard = value;
    }
    private static DjinnGuard _DjinnGuard;
    private static DoomVaultA DoomVaultA
    {
        get => _DoomVaultA ??= new DoomVaultA();
        set => _DoomVaultA = value;
    }
    private static DoomVaultA _DoomVaultA;
    private static DoomVaultB DoomVaultB
    {
        get => _DoomVaultB ??= new DoomVaultB();
        set => _DoomVaultB = value;
    }
    private static DoomVaultB _DoomVaultB;
    private static Downward Downward
    {
        get => _Downward ??= new Downward();
        set => _Downward = value;
    }
    private static Downward _Downward;
    private static DracoCon DracoCon
    {
        get => _DracoCon ??= new DracoCon();
        set => _DracoCon = value;
    }
    private static DracoCon _DracoCon;
    private static DragonFableOrigins DragonFableOrigins
    {
        get => _DragonFableOrigins ??= new DragonFableOrigins();
        set => _DragonFableOrigins = value;
    }
    private static DragonFableOrigins _DragonFableOrigins;
    private static DragonRoad DragonRoad
    {
        get => _DragonRoad ??= new DragonRoad();
        set => _DragonRoad = value;
    }
    private static DragonRoad _DragonRoad;
    ...
    private static Dwarfhold Dwarfhold
    {
        get => _Dwarfhold ??= new Dwarfhold();
        set => _Dwarfhold = value;
    }
    private static Dwarfhold _Dwarfhold;
    private static DwarvesVsGiants DwarvesVsGiants
    {
        get => _DwarvesVsGiants ??= new DwarvesVsGiants();
        set => _DwarvesVsGiants = value;
    }
    private static DwarvesVsGiants _DwarvesVsGiants;
    ...
    private static EtherStormWastes EtherStormWastes
    {
        get => _EtherStormWastes ??= new EtherStormWastes();
        set => _EtherStormWastes = value;
    }
    private static EtherStormWastes _EtherStormWastes;
    private static ExaltiaTower ExaltiaTower
    {
        get => _ExaltiaTower ??= new ExaltiaTower();
        set => _ExaltiaTower = value;
    }
    private static ExaltiaTower _ExaltiaTower;
    private static Extinction Extinction
    {
        get => _Extinction ??= new Extinction();
        set => _Extinction = value;
    }
    private static Extinction _Extinction;
    ...
    private static Friendship _Friendship;
    private static FrozenNorthlands FrozenNorthlands
    {
        get => _FrozenNorthlands ??= new FrozenNorthlands();
        set => _FrozenNorthlands = value;
    }
    private static FrozenNorthlands _FrozenNorthlands;

    private static Gamehaven Gamehaven
    {
        get => _Gamehaven ??= new Gamehaven();
        set => _Gamehaven = value;
    }
    private static Gamehaven _Gamehaven;
    ...
    private static Guru _Guru;

    private static HuntersMoon HuntersMoon
    {
        get => _HuntersMoon ??= new HuntersMoon();
        set => _HuntersMoon = value;
    }
    private static HuntersMoon _HuntersMoon;

    private static IcePlane IcePlane
    {
        get => _IcePlane ??= new IcePlane();
        set => _IcePlane = value;
    }
    private static IcePlane _IcePlane;

    private static LaeWedding LaeWedding
    {
        get => _LaeWedding ??= new LaeWedding();
        set => _LaeWedding = value;
    }
    private static LaeWedding _LaeWedding;
    ...
    private static Lightguard Lightguard
    {
        get => _Lightguard ??= new Lightguard();
        set => _Lightguard = value;
    }
    private static Lightguard _Lightguard;
    private static LightoviaCave LightoviaCave
    {
        get => _LightoviaCave ??= new LightoviaCave();
        set => _LightoviaCave = value;
    }
    private static LightoviaCave _LightoviaCave;
    private static LostVilla LostVilla
    {
        get => _LostVilla ??= new LostVilla();
        set => _LostVilla = value;
    }
    private static LostVilla _LostVilla;

    private static Manor Manor
    {
        get => _Manor ??= new Manor();
        set => _Manor = value;
    }
    private static Manor _Manor;
    private static Marsh2 Marsh2
    {
        get => _Marsh2 ??= new Marsh2();
        set => _Marsh2 = value;
    }
    private static Marsh2 _Marsh2;
    ...
    private static Mobius _Mobius;
    private static MustyCave MustyCave
    {
        get => _MustyCave ??= new MustyCave();
        set => _MustyCave = value;
    }
    private static MustyCave _MustyCave;

    private static NecroProject NecroProject
    {
        get => _NecroProject ??= new NecroProject();
        set => _NecroProject = value;
    }
    private static NecroProject _NecroProject;
    private static Noobshire Noobshire
    {
        get => _Noobshire ??= new Noobshire();
        set => _Noobshire = value;
    }
    private static Noobshire _Noobshire;
    ...
    private static NytheraSaga NytheraSaga
    {
        get => _NytheraSaga ??= new NytheraSaga();
        set => _NytheraSaga = value;
    }
    private static NytheraSaga _NytheraSaga;

    private static J6Saga J6Saga
    {
        get => _J6Saga ??= new J6Saga();
        set => _J6Saga = value;
    }
    private static J6Saga _J6Saga;

    private static Pirates Pirates
    {
        get => _Pirates ??= new Pirates();
        set => _Pirates = value;
    }
    private static Pirates _Pirates;
    private static PoisonForest PoisonForest
    {
        get => _PoisonForest ??= new PoisonForest();
        set => _PoisonForest = value;
    }
    private static PoisonForest _PoisonForest;

    private static QueenReign QueenReign
    {
        get => _QueenReign ??= new QueenReign();
        set => _QueenReign = value;
    }
    private static QueenReign _QueenReign;
    private static QuibbleHunt QuibbleHunt
    {
        get => _QuibbleHunt ??= new QuibbleHunt();
        set => _QuibbleHunt = value;
    }
    private static QuibbleHunt _QuibbleHunt;
    ...
    private static River _River;

    private static Safiria Safiria
    {
        get => _Safiria ??= new Safiria();
        set => _Safiria = value;
    }
    private static Safiria _Safiria;
    ...
    private static ShadowSlayerK ShadowSlayerK
    {
        get => _ShadowSlayerK ??= new ShadowSlayerK();
        set => _ShadowSlayerK = value;
    }
    private static ShadowSlayerK _ShadowSlayerK;
    private static ShadowVault ShadowVault
    {
        get => _ShadowVault ??= new ShadowVault();
        set => _ShadowVault = value;
    }
    private static ShadowVault _ShadowVault;
    ...
    private static Shattersword Shattersword
    {
        get => _Shattersword ??= new Shattersword();
        set => _Shattersword = value;
    }
    private static Shattersword _Shattersword;
    private static Shinkansen Shinkansen
    {
        get => _Shinkansen ??= new Shinkansen();
        set => _Shinkansen = value;
    }
    private static Shinkansen _Shinkansen;
    ...
    private static SpirePast SpirePast
    {
        get => _SpirePast ??= new SpirePast();
        set => _SpirePast = value;
    }
    private static SpirePast _SpirePast;
    private static StarSinc StarSinc
    {
        get => _StarSinc ??= new StarSinc();
        set => _StarSinc = value;
    }
    private static StarSinc _StarSinc;
    private static SuperDeath SuperDeath
    {
        get => _SuperDeath ??= new SuperDeath();
        set => _SuperDeath = value;
    }
    private static SuperDeath _SuperDeath;

    private static ThirdSpell ThirdSpell
    {
        get => _ThirdSpell ??= new ThirdSpell();
        set => _ThirdSpell = value;
    }
    private static ThirdSpell _ThirdSpell;
    private static TitanAttackStory TitanAttackStory
    {
        get => _TitanAttackStory ??= new TitanAttackStory();
        set => _TitanAttackStory = value;
    }
    private static TitanAttackStory _TitanAttackStory;
    ...
    private static TowerOfDoom TowerOfDoom
    {
        get => _TowerOfDoom ??= new TowerOfDoom();
        set => _TowerOfDoom = value;
    }
    private static TowerOfDoom _TowerOfDoom;
    ...
    private static Ubear Ubear
    {
        get => _Ubear ??= new Ubear();
        set => _Ubear = value;
    }
    private static Ubear _Ubear;
    private static UnderGroundLab UnderGroundLab
    {
        get => _UnderGroundLab ??= new UnderGroundLab();
        set => _UnderGroundLab = value;
    }
    private static UnderGroundLab _UnderGroundLab;
    ...
    private static WatchTower WatchTower
    {
    ...
    private static WillowCreek _WillowCreek;

    private static XansLair Xans
    {
        get => _Xans ??= new XansLair();
        set => _Xans = value;
    }
    private static XansLair _Xans;
    ...
    public void CompleteAll()
    {
        ...
        if (
            !Core.HasAchievement(30, "ip6")
            || Core.isCompletedBefore(5981)
            || !Core.CheckInventory(27222)
            || !Core.IsMember
        )
        {
            BoneBreak.StoryLine();
        ...
        if (
            Core.HasAchievement(22, "ip9")
            || Core.HasAchievement(15, "ip11")
            || Core.HasAchievement(8, "ip14")
            || !Core.HasAchievement(10, "ip16")
            || !Core.HasAchievement(12, "ip17")
            || !Core.HasAchievement(18, "ip18")
            || !Core.HasAchievement(2, "ip20")
        )
        {
