...
public class CoreArmyRep
{
    ...
    public void ArmyArcangroveRep() =>
        RunArmyRep(
            "Arcangrove",
            "arcangrove",
            new[] { "Left", "Back", "Right", "LeftBack" },
            new[] { "Left", "Back", "Right", "LeftBack" },
            new[] { 794, 795, 796, 797, 798, 799, 800, 801 }
        );

    public void ArmyBaconCatRep() =>
        RunArmyRep(
            "BaconCat",
            "baconcatlair",
            new[] { "r4" },
    ...
    public void ArmyDoomWoodRep() =>
        RunArmyRep(
            "DoomWood",
            "shadowfallwar",
            new[] { "Garden2", "Garden1", "Bonus" },
            new[] { "Garden2", "Garden1", "Bonus" },
            new[] { 1151, 1152, 1153 }
        );

    public void ArmyCraggleRockRep() =>
        RunArmyRep(
            "CraggleRock",
            "wanders",
            new[] { "r2", "r3", "r5", "r7" },
    ...
    public void ArmyChaosMilitiaRep() =>
        RunArmyRep(
            "Chaos Militia",
            "citadel",
            new[] { "m1", "m5", "m9" },
    ...
    public void ArmyDreadrockRep() =>
        RunArmyRep(
            "Dreadrock",
            "dreadrock",
            new[] { "r3", "r8a" },
            new[] { "r3", "r8a" },
            new[] { 4863, 4862, 4865, 4868 }
        );

    public void ArmyChronoSpanRep() =>
        RunArmyRep(
            "ChronoSpan",
            "thespan",
            new[] { "r4", "r3", "r2" },
    ...
    public void ArmyDruidGroveRep() =>
        RunArmyRep(
            "Druid Grove",
            "bloodtusk",
            new string[] { "r8", "r3", "r18" },
            new string[] { "r8", "r3", "r18" },
            new int[] { 3049 }
        );

    public void ArmyDwarfholdRep() =>
        RunArmyRep(
            "Dwarfhold",
            "pines",
            new string[] { "Enter", "Mountain" },
            new string[] { "Enter", "Mountain" },
            new int[] { 320, 321 }
        );

    public void ArmyElementalMasterRep() =>
        RunArmyRep(
            "Elemental Master",
            "gilead",
            new[] { "r8", "r3", "r4" },
    ...
    public void ArmyEtherstormRep() =>
        RunArmyRep(
            "Etherstorm",
            "etherwardes",
            new string[] { "Enter", "r3", "r2" },
            new string[] { "Enter", "r3", "r2" },
            new int[] { 1721 }
        );

    public void ArmyEmberseaRep() =>
        RunArmyRep(
            "Embersea",
            "fireforge",
            new string[] { "r5", "r8", "r7" },
            new string[] { "r5", "r8", "r7" },
            new int[] { 4227, 4228, 4229 }
        );

    public void ArmyEternalRep() =>
        RunArmyRep(
            "Eternal",
            "fourdpyramid",
            new[] { "r10", "r11" },
    ...
    public void ArmyInfernalArmyRep() =>
        RunArmyRep(
            "Infernal Army",
            "dreadfire",
            new[] { "r10", "r10a", "r10b" },
            new[] { "r10", "r10a", "r10b" },
            new int[] { 5707, 5708, 5709 }
        );

    public void ArmyMythsongRep() =>
        RunArmyRep(
            "Mythsong",
            "beehive",
            new[] { "r1", "r2", "r3", "r4" },
    ...
    public void ArmyMysteriousDungeonRep() =>
        RunArmyRep(
            "Mysterious Dungeon",
            "wanders",
            new[] { "r2", "r3", "r5", "r7" },
            new[] { "r2", "r3", "r5", "r7" },
            new[] { 5429, 5430, 5431, 5432 }
        );

    public void ArmyNecroCryptRep() =>
        RunArmyRep(
            "Necro Crypt",
            "castleundead",
            new[] { "Enter", "Bright", "Hall" },
            new[] { "Enter", "Bright", "Hall" },
            new[] { 3048 }
        );

    public void ArmyNorthpointeRep() =>
        RunArmyRep(
            "Northpointe",
            "Northpointe",
            new[] { "r13", "r11", "r8" },
    ...
    public void ArmySandseaRep() =>
        RunArmyRep(
            "Sandsea",
            "Sandsea",
            new[] { "Enter", "r6", "r7", "r8" },
            new[] { "Enter", "r6", "r7", "r8" },
            new[] { 916, 917, 919, 921, 922 }
        );

    public void ArmySomniaRep() =>
        RunArmyRep(
            "Somnia",
            "Somnia",
            new[] { "r8", "r4", "r7" },
    ...
    public void ArmySwordhavenRep() =>
        RunArmyRep(
            "Swordhaven",
            "Swordhavencastle",
            new[] { "r4", "r3", "r5" },
            new[] { "r4", "r3", "r5" },
            new[] { 3065, 3066, 3067, 3070, 3085, 3086, 3087 }
        );

    public void ArmyTreasureHunterRep() =>
        RunArmyRep(
            "TreasureHunter",
            "stalagbite",
            new[] { "Enter", "r1" },
    ...
    public void ArmyLoremasterRep() =>
        RunArmyRep(
            "Loremaster",
            Core.IsMember ? "druids" : "wardwarf",
            new[] { Core.IsMember ? "r5" : "r2", Core.IsMember ? "r5" : "r4" },
            new[] { Core.IsMember ? "r5" : "r2", Core.IsMember ? "r5" : "r4" },
            Core.IsMember ? new[] { 3032 } : new[] { 7505 }
        );

    public void ArmyLycanRep() =>
        RunArmyRep("Lycan", "Lycan", new[] { "r4", "r5" }, new[] { "r4", "r5" }, new[] { 537 });

    public void ArmyMonsterHunterRep() =>
        RunArmyRep(
            "Monster Hunter",
            "pilgrimage",
            new[] { "r5", "r7", "r8", "r9" },
    ...
    public void ArmySkyeRep() =>
        RunArmyRep(
            "Skye",
            "balemorale",
            new[] { "r2", "r4", "r6", "r7", "r9", "r10" },
            new[] { "r2", "r4", "r6", "r7", "r9", "r10" },
            new[] { 9709, 9710, 9711, 9717 }
        );
    ...
    )
    {
        ...
        switch (repname)
        {
            ...
            case "Skye":
                ...
                {
                    Core.Logger(
                        "Quest \"Your Hero [9125]\" Not complete (you have to do this yourself), cannot continue the rep",
                        stopBot: true
                    );
                    return;
                }
