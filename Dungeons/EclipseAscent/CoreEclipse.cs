...
public class CoreEclipse
{
    ...
    public void GetSliverOfMoonlight(int count = 221)
    { //220 for the sword, 1 for Rite of Ascension
        new SolsticeMoon(this, count);
    }

    public void GetSliverOfSunlight(int count = 221)
    { //220 for the sword, 1 for Rite of Ascension
        new MidnightSun(this, count);
    }

    public void GetEclipticOffering(int count = 155)
    { //155 for the sword
